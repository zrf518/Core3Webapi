...
namespace CeCheng.SmartScenicSpot.Models
{
    ...
    /// 优惠政策
    /// </summary>
    public class CardPolicyDto :BasePageDto
    {
        /// <summary>
        /// 自增长ID
        /// </summary>
    ...
    /// 优惠政策查询条件实体
    /// </summary>
    public class CardPolicySearchParamDto : CardPolicyDto
    {
        /// <summary>
        /// 卡类型ID
        /// </summary>
        ...
        /// 折扣代码ID
        /// </summary>
        public int? cardpolicy_specm_id { get; set; }

        /// <summary>
        /// 折扣代码名称
        /// </summary>
        public string cardpolicy_specm_name { get; set; }

        /// <summary>
        /// 房价代码ID
        /// </summary>
        public int? sm_ratecode_id { get; set; }

        /// <summary>
        /// 房价代码名称
        /// </summary>
        public string sm_ratecode_name { get; set; }

        /// <summary>
        /// "免费服务"类型名称
        /// </summary>
        public string s_free_tax_name { get; set; }
    }

    /// <summary>
    /// 优惠政策查询结果实体
    /// </summary>
    public class CardPolicySearchResultDto : CardPolicyDto
    {
        /// <summary>
        /// 卡类型ID
        /// </summary>
